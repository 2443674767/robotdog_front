...
// const localhost="http://10.21.41.241:8500";
window.globalConfig = {
	Main_url:`${domain}`,//域名
    ...
    RtspVisible: "rtsp://10.21.31.64/live/main",
    RtspThermal: "rtsp://10.21.31.64/live//thermal",
    StreamPlayUrl: "http://localhost:8080/robotdog/m20_jx_single.live.flv",
    StreamPlayUrlVisible: "http://localhost:8080/robotdog/m20_jx_single.live.flv", 
    StreamPlayUrlThermal: "http://localhost:8080/robotdog/m20_jx_ir.live.flv",
    VideoStreams: [
      {
        key: "visible",
        label: "可见光",
        ...
        rtsp: "rtsp://10.21.31.64/live/main",
      ...
      },
      {
        ...
        rtsp: "rtsp://10.21.31.64/live//thermal",
    ...
    RtspUrl: "rtsp://10.21.31.64/live/main",
    WebRtcMode: "go2rtc",
    WebRtcGateway: "",
};
