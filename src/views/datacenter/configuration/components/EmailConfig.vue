<template>
   <a-card class="general-card contentcard" >
        ...
        <a-col :span="12">
            ...
            field="sender_email"
            >
            <a-input v-model="formEmail.senderEmail" placeholder="填写发送者邮箱" allow-clear/>
            </a-form-item>
        </a-col>
        <a-col :span="12">
            <a-form-item
            ...
            field="auth_code"
            >
            <a-input v-model="formEmail.authCode" placeholder="填写邮箱授权码" allow-clear/>
            </a-form-item>
        </a-col>
        <a-col :span="12">
            <a-form-item
            ...
            field="service_host"
            >
            <a-input v-model="formEmail.serviceHost" placeholder="填写邮件服务器" allow-clear/>
            </a-form-item>
        </a-col>
        <a-col :span="12">
            <a-form-item
            ...
            field="service_port"
            >
            <a-input v-model="formEmail.servicePort" placeholder="填写邮件服务器端口" allow-clear/>
            </a-form-item>
        </a-col>
        ...
        <a-col :span="16">
            ...
            field="mail_title"
            >
            <a-input v-model="formEmail.mailTitle" placeholder="填写邮件标题" allow-clear/>
            </a-form-item>
        </a-col>
        <a-col :span="24">
            <a-form-item
            ...
            >
            <a-textarea v-model="formEmail.mailBody" placeholder="填写邮件内容" allow-clear :auto-size="{minRows:3,maxRows:5}"/>
            </a-form-item>
        </a-col>
        <a-col :span="24">
            <a-form-item >
