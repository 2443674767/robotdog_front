  ...
  <a-card :title="$t('userSetting.title.basicInfo')" bordered class="gradient-card">
    <div class="body">
      <section>
        ...
        <div class="name">
          <span style="margin-right: 10px">{{ userdata.nickname }}</span>
    ...
    <div class="footer">{{ $t('userSetting.label.registered') }} {{dayjs(userStore.created_at).format("YYYY-MM-DD HH:mm")}}</div>
  </a-card>
