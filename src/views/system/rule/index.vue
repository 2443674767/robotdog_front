      ...
      <a-row style="margin-bottom: 10px">
        ...
        >
          <tabletool :showbtn="['create','refresh','selectdensity','fullscreen']"
           @create="createData" @refresh="fetchData" @selectdensity="(data:any)=>size=data" @fullscreen="(data:any)=>isFullscreen=data">
...
<script lang="ts" setup>
  ...
  const orrdersave=async(weighList:any,id:any,pid:any)=>{
    ...
    try {
        ...
        await tableWeigh({weighList:weighList,id:id,pid:pid,tablename:"admin_auth_rule"});
