...
<script lang="ts" setup>
  ...
  const contentOpts = computed(() => [
    ...
    { name: 'settings.tabMode', key: 'tabMode', defaultVal: appStore.tabMode,type: 'select',selectList: tabModeList, disablSelect: !appStore.tabBar},
...
const toggleLayout = (layout: string) => {
  ...
  if(layout=="top"){
    appStore.topMenu=true
  }else{
    appStore.topMenu=false
  }
}
</script>
