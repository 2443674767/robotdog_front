...
export interface DocInterface<T = any> extends EvemtEmitter3 {
...
export interface SelectionInterface extends EvemtEmitter3 {
	/**
	 * 当前光标路径
	 */
...
export interface MutationInterface extends EvemtEmitter3 {
	/**
	 * 是否终止中
	 */
	isStopped: boolean;
...
export interface OTInterface extends EvemtEmitter3 {
	// 操作消费者
