...
export interface ControllBarInterface extends EvemtEmitter3 {
	/**
	 * 拖动参数
	 */
...
export interface TableCommandInterface extends EvemtEmitter3 {
	init(): void;
...
export interface TableSelectionInterface extends EvemtEmitter3 {
